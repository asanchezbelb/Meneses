...
def main():
    try:
        ...
        sql_query = ''' 
        SELECT * 
        FROM DB_UOC_PROD.STG_CANVAS_CD2.CANVAS_DISCUSSION_ENTRY_PARTICIPANTS 
        LIMIT 10000;
        '''
        ...
        with open('data/interacciones.csv', mode='w', newline='', encoding='utf-8') as file:
        ...
        print("Datos guardados en 'data/interacciones.csv'")
